#!/usr/bin/env python3
"""Verify six-/seven-core branches with three non-K6 cores."""
...
def minimum_edges(
    ...
    model.add(sum(d_selected) == core_count - 3)
    selections.extend(
...
def main() -> None:
    ...
    for pattern in combinations_with_replacement(KINDS, 3):
    ...
    print("PASS rebuilt all ten three-exceptional type triples")
    ...
    print("SCOPE: six/seven cores with exactly three non-K6 cores")
