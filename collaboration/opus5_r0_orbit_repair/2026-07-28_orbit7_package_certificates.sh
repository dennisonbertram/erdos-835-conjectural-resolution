...
package_dir=${PACKAGE_DIR:-"$script_dir/2026-07-28_orbit7_fixed_pair_cnf"}
...
cp "$script_dir/2026-07-28_orbit7_fixed_pair_verify.py" \
    "$package_dir/orbit7_fixed_pair_verify.py"
...
cp "$script_dir/2026-07-28_orbit7_fixed_pair_results.jsonl" \
    "$package_dir/orbit7_fixed_pair_results.jsonl"
cp "$script_dir/2026-07-28_orbit7_merge_results.py" \
    "$package_dir/orbit7_merge_results.py"
for worker_index in 0 1 2 3; do
    cp "$script_dir/2026-07-28_orbit7_fixed_pair_worker_$worker_index.jsonl" \
        "$package_dir/orbit7_fixed_pair_worker_$worker_index.jsonl"
done
cp "$script_dir/2026-07-28_orbit7_fixed_pair_classifier_audit.json" \
    "$package_dir/CLASSIFIER_AUDIT.json"
cp "$script_dir/2026-07-28_orbit7_fixed_pair_raw_audit.json" \
    "$package_dir/RAW_AUDIT.json"
cp "$script_dir/2026-07-28_orbit7_certificate_results.json" \
    "$package_dir/CERTIFICATE_RESULTS.json"
cp "$script_dir/2026-07-28_orbit7_toolchain.json" \
    "$package_dir/TOOLCHAIN.json"
cp "$script_dir/2026-07-28_orbit7_verify_certificates.sh" \
    "$package_dir/verify_certificates.sh"
cp "$script_dir/2026-07-28_orbit7_generate_proofs.sh" \
    "$package_dir/generate_proofs.sh"
cp "$script_dir/2026-07-28_orbit7_replay_raw.sh" \
    "$package_dir/replay_raw.sh"
cp "$script_dir/2026-07-28_orbit7_package_certificates.sh" \
...
(
    ...
    shasum -a 256 \
        ...
        TOOLCHAIN.json \
        generate_proofs.sh \
        orbit7_fixed_pair_results.jsonl \
        orbit7_fixed_pair_verify.py \
        orbit7_fixed_pair_worker_0.jsonl \
        orbit7_fixed_pair_worker_1.jsonl \
        orbit7_fixed_pair_worker_2.jsonl \
        orbit7_fixed_pair_worker_3.jsonl \
        orbit7_merge_results.py \
