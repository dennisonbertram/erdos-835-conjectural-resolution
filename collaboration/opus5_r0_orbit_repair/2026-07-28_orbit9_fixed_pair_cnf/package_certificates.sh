...
raw_dir=${RAW_DIR:-"$script_dir/2026-07-28_orbit9_fixed_pair_raw"}
proof_dir=${PROOF_DIR:-"$script_dir/2026-07-28_orbit9_fixed_pair_proof_work"}
package_dir=${PACKAGE_DIR:-"$script_dir/2026-07-28_orbit9_fixed_pair_cnf"}
...
cp "$script_dir/2026-07-28_orbit9_fixed_pair_verify.py" \
    "$package_dir/orbit9_fixed_pair_verify.py"
...
cp "$script_dir/2026-07-28_orbit9_fixed_pair_results.jsonl" \
    "$package_dir/orbit9_fixed_pair_results.jsonl"
cp "$script_dir/2026-07-28_orbit9_merge_results.py" \
    "$package_dir/orbit9_merge_results.py"
for worker_index in 0 1 2 3; do
    cp "$script_dir/2026-07-28_orbit9_fixed_pair_worker_$worker_index.jsonl" \
        "$package_dir/orbit9_fixed_pair_worker_$worker_index.jsonl"
done
cp "$script_dir/2026-07-28_orbit9_fixed_pair_classifier_audit.json" \
    "$package_dir/CLASSIFIER_AUDIT.json"
cp "$script_dir/2026-07-28_orbit9_fixed_pair_raw_audit.json" \
    "$package_dir/RAW_AUDIT.json"
cp "$script_dir/2026-07-28_orbit9_certificate_results.json" \
    "$package_dir/CERTIFICATE_RESULTS.json"
cp "$script_dir/2026-07-28_orbit9_toolchain.json" \
    "$package_dir/TOOLCHAIN.json"
cp "$script_dir/2026-07-28_orbit9_cut_sufficiency.md" \
    "$package_dir/ORBIT9_THEOREM.md"
cp "$script_dir/2026-07-28_orbit9_verify_certificates.sh" \
    "$package_dir/verify_certificates.sh"
cp "$script_dir/2026-07-28_orbit9_generate_proofs.sh" \
    "$package_dir/generate_proofs.sh"
cp "$script_dir/2026-07-28_orbit9_replay_raw.sh" \
    "$package_dir/replay_raw.sh"
cp "$script_dir/2026-07-28_orbit9_package_certificates.sh" \
...
for case_index in $all_cases; do
    case_name=orbit9_pair_$case_index
    record_and_compress \
...
(
    ...
    shasum -a 256 \
        ...
        TOOLCHAIN.json \
        generate_proofs.sh \
        orbit9_fixed_pair_results.jsonl \
        orbit9_fixed_pair_verify.py \
        orbit9_fixed_pair_worker_0.jsonl \
        orbit9_fixed_pair_worker_1.jsonl \
        orbit9_fixed_pair_worker_2.jsonl \
        orbit9_fixed_pair_worker_3.jsonl \
        orbit9_merge_results.py \
